...
public class TrendServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        stringBuilder.append("<button type='button' value='Get Trends' onclick='getTrends();' /><br />\n");
        stringBuilder.append("<hr /><br />\n");
        stringBuilder.append("</form>\n");
        stringBuilder.append("<div id='trendData'></div>\n");
        stringBuilder.append("</body>\n");
        stringBuilder.append("</html>\n");
        ...
        stringBuilder.append("var startDate = document.getElementById(\"startDate\");\n");
        stringBuilder.append("alert(\"2\");\n");
        stringBuilder.append("var endDate = document.getElementById(\"endDate\");\n");
        stringBuilder.append("alert(\"3\");\n");
        stringBuilder.append("var trendId = document.getElementById(\"trendList\");\n");
        ...
        stringBuilder.append("xhr.open(\"POST\",\"trendservice/\" + startDate + \"/\" + endDate + \"/\" + trendId);\n");
